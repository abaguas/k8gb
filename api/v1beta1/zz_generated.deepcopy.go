...
func (in *GslbSpec) DeepCopyInto(out *GslbSpec) {
	*out = *in
	...
	if in.MetricsHealthChecks != nil {
		in, out := &in.MetricsHealthChecks, &out.MetricsHealthChecks
		*out = make([]MetricsHealthCheck, len(*in))
		copy(*out, *in)
	}
}
...
func (in *GslbStatus) DeepCopyInto(out *GslbStatus) {
	*out = *in
	...
	if in.MetricHealth != nil {
		in, out := &in.MetricHealth, &out.MetricHealth
		*out = make(map[string]HealthStatus, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MetricsHealthCheck) DeepCopyInto(out *MetricsHealthCheck) {
	*out = *in
	out.CustomMetric = in.CustomMetric
	out.ExternalMetric = in.ExternalMetric
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MetricsHealthCheck.
func (in *MetricsHealthCheck) DeepCopy() *MetricsHealthCheck {
	if in == nil {
		return nil
	}
	out := new(MetricsHealthCheck)
	in.DeepCopyInto(out)
	return out
}

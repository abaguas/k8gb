...
type GslbSpec struct {
	...
	// Hostnames exposed by the GSLB. This information is extracted automatically from the 'ingress' or 'resourceRef' configuration (optional)
	Hostames []string `json:"hosts,omitempty"`
	// Kubernetes Services backing the load balanced application. This information is extracted automatically from the 'ingress' or 'resourceRef' configuration (optional)

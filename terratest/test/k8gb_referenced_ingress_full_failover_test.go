...
func TestReferencedIngressFullFailover(t *testing.T) {
	const host = "terratest-failover.cloud.example.com"
	const gslbPath = "../examples/failover-referenced-ingress-gslb.yaml"
	const ingressPath = "../examples/failover-referenced-ingress-ingress.yaml"
